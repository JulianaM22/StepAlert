...
void setup() {
  ...
  data_charic = pService->createCharacteristic(
    ...
    BLECharacteristic::PROPERTY_NOTIFY| //new code
    BLECharacteristic::PROPERTY_INDICATE//new code
  );
...
void loop() {
  ...
  int newNewNewDistance = (int)newDistance;
  data_charic->setValue(newNewNewDistance); 
  data_charic->notify(); //notify of data being changed
